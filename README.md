...
`NOTION_API_TOKEN` を設定すると、bundled `ntn v0.4.0` を使って Notion を read-only 参照できます。初期スコープでは page search と page facts 読み出しだけを使い、Notion は task system of record にはしません。
