...
`LINEAR_WORKSPACE` is descriptive only. When `LINEAR_API_KEY` is present, the runtime avoids combining it with `-w/--workspace`, including on `linear-cli v3.0.0`.
