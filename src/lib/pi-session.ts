...
export function buildSystemPrompt(config: AppConfig, assistantName = "コギト"): string {
  return [
    ...
    "If one requested item should reuse an existing issue, inspect it first with linear_search_issues or linear_get_issue_facts and then use propose_link_existing_issue.",
    ...
    "For multi-item create_work requests, decide item by item whether each item should create a new issue or link to an existing issue.",
