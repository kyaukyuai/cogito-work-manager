...
import { createCompatIntakeLedgerWriter } from "../state/compat/intake-ledger-writer.js";
import {
  type LinearIssue,
} from "./linear.js";
import {
...
export async function handleManagerMessage(
  ...
  const compatIntakeLedger = createCompatIntakeLedgerWriter(repositories.intake, {
    fingerprintText,
    nowIso,
  });
