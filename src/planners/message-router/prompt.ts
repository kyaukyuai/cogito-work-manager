...
export function buildMessageRouterPrompt(input: MessageRouterInput): string {
  ...
  return [
    ...
    '{"action":"query","queryKind":"list-active"|"list-today"|"what-should-i-do"|"inspect-work"|"search-existing"|"recommend-next-step","queryScope":"self"|"team"|"thread-context","confidence":number,"reasoningSummary":string}',
